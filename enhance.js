...
(function () {
  ...
  function enhance() {
    ...
    if (heroVisual && !heroVisual.querySelector(".fx-ba-wrap")) {
      ...
      // Gercek far fotograflari (build-single.cjs data-URI gomer).
      // Taban katman = SAG tarafta gorunur -> ONCE (sararmis). Kirpilan ust katman = SOL -> SONRA (net).
      var imgOnce = "__BA_ONCE__";    // sararmis far
      var imgSonra = "__BA_SONRA__";  // net far
      ...
      wrap.innerHTML =
        ...
        '<div class="fx-ba">' +
          '<div class="fx-ba-layer"><img src="' + imgOnce + '" alt="Sararmış far — önce" draggable="false"></div>' +
          '<div class="fx-ba-layer fx-ba-after"><img src="' + imgSonra + '" alt="Yenilenmiş far — sonra" draggable="false"></div>' +
